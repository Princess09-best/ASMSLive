...
class ApplicationProvider extends ChangeNotifier {
  ...
  Future<bool> submitApplication(int scholarshipId, Map<String, dynamic> formData) async {
    _isLoading = true;
    notifyListeners();
  ...
  Future<bool> uploadDocument(
    ...
    try {
      ...
      if (_selectedApplication != null && _selectedApplication!.id == applicationId) {
        ...
        final updatedDocuments = [..._selectedApplication!.documents, newDocument];
  ...
  List<Application> filterApplicationsByStatus(String status) {
    return _applications.where((application) => application.status == status).toList();
  }
} 